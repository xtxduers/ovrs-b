...
def add_cat_seg_config(cfg):
    ...
    cfg.MODEL.SEM_SEG_HEAD.ENTROPY_TEMPERATURE = 1.0
    cfg.MODEL.SEM_SEG_HEAD.ENTROPY_EPS = 1e-6
    cfg.MODEL.SEM_SEG_HEAD.ENTROPY_CONFIDENCE_THRESHOLD = 0.5
    cfg.MODEL.SEM_SEG_HEAD.ENTROPY_MLP_HIDDEN_DIM = 16
    cfg.MODEL.SEM_SEG_HEAD.ENTROPY_STAGE = 2
